...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function component($name, $props = [], $layoutData = [], $viewData = [])
        {
                        return \Illuminate\View\Factory::component($name, $props, $layoutData, $viewData);
        }
     ...
     */ 
        ...
        {
                        /** @var \Letsgoi\HealthCheck\HealthCheck $instance */
                        return $instance->check($checker);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getCheckErrors()
        {
                        /** @var \Letsgoi\HealthCheck\HealthCheck $instance */
                        return $instance->getCheckErrors();
        }
...
namespace  { 
            ...
            class HealthCheck extends \Letsgoi\HealthCheck\Facades\HealthCheck {}
