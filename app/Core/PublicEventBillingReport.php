...
class PublicEventBillingReport
{
    ...
    protected static function header(Worksheet $sheet, $merchant)
    {
        ...
        $headerText .= 'и Общество с ограниченной ответственностью "Бессовестно Талантливый" ';
        $headerText .= 'в лице Генерального директора Абрамова Вадима Рашпильевича, действующей на основании Устава, именуемого в дальнейшем «Агент», ';
