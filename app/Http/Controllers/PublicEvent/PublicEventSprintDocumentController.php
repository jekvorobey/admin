...
{
    public function list(Request $request, PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService)
    {
    ...
    public function page(Request $request, PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService)
    {
    ...
    public function save(Request $request, PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService)
    {
        $id = $request->get('id');
    ...
    public function delete(Request $request, PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService)
    {
        $ids = $request->get('ids');
    ...
    public function getBySprint(int $sprint_id, PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService)
    {
     ...
     * @throws PimException
     */
    private function loadPublicEventSprintDocuments(PublicEventSprintDocumentService $publicEventPublicEventSprintDocumentService, $page): array
    {
