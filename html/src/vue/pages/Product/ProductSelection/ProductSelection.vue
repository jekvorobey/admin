<template>
    <layout-main>
        <b-card>
            ...
            <div class="row">
                <f-text-area-search v-if="this.isOfferId" placeholderName="Введите Offer ID через запятую"
                                    v-model="filter.offerId" class="col-sm-12 col-md-8 col-xl-8"></f-text-area-search>
                <f-text-area-search v-else placeholderName="Введите Артикулы через запятую" v-model="filter.vendorCode"
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    code: 'xmlId',
                    value: function (claim) {
                        return claim.xmlId ? claim.xmlId : 'N/A';
                    },
                    isShown: true,
                    isAlwaysShown: true,
                },
