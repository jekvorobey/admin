    ...
    <layout-main>
        <b-card>
            ...
            <div class="row">
                ...
                <f-multi-select v-model="filter.statuses" :options="toOptionsArray(statusNames)"
                                class="col-sm-12 col-md-3 col-xl-4">
                    Статус
                </f-multi-select>
        ...
        <div class="row mb-3" v-if="canUpdate(blocks.products)">
            <div class="col-12 mt-3">
                ...
                <button class="btn btn-warning" :disabled="countSelected < 1 || isEmptyStockOfferSelected()"
                        @click="editOfferStatus()">Изменить статус
                    <template v-if="countSelected <= 1">оффера</template>
                    <template v-else>офферов</template>
                </button>
                <button class="btn btn-primary" :disabled="countSelected !== 1" @click="editOffer(selectedOffers[0])">
                    Редактировать оффер
                </button>
            </div>
        </div>
