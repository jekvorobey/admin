            ...
            <modal :close="closeModal" v-if="isModalOpen('BrandFormModal')">
                ...
                <div slot="body">
                    <div class="form-group">
                        ...
                        <v-input v-model="$v.form.description.$model" :error="errorDescription" tag="textarea">
                            Описание*
                        </v-input>
                        <img v-if="form.file_id" :src="fileUrl(form.file_id)" class="preview">
                        <file-input destination="brand" :error="errorFile" @uploaded="onFileUpload">Логотип*
                        </file-input>
                        <b-row class="mt-3">
                            <b-col cols="4">
