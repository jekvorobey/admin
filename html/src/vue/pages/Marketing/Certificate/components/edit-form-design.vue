            ...
            <div class="form-group required">
                ...
                <a href="#" @click.prevent="openModal('ImageUpload')" class="gift-certificate-design-preview shadow-sm"
                   :style="{ backgroundImage: 'url(' + preview + ')'}">
                    <svg v-if="!preview" style="height: 50px;" xmlns="http://www.w3.org/2000/svg" fill="none"
                         viewBox="0 0 24 24"
                         stroke="currentColor">
                ...
                <small style="color: #666;">
                    Рекомендуемый размер изображения 500x300 (не более 1Мб). Формат - JPG или PNG.
                </small>
            </div>
...
export default {
    ...
    mounted() {
        ...
        this.is_active = design.is_active || 0
